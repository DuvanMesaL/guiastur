<?php
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Contracts/UseCases/ICreateAtencionUseCase.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Contracts/Actions/Commands/ICreateAtencionCommand.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Contracts/Actions/Queries/IValidateAtencionQuery.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Exceptions/invalidAtencionException.php";
