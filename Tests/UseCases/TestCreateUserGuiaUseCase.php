...
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Actions/Commands/CreateUser/CreateUserGuiaCommandHandler.php";
...
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/UseCases/CreateUser/CreateUserGuiaUseCase.php";
