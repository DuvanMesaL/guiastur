...
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Actions/Commands/FinishTurnoCommandHandler.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Actions/Queries/GetTurnoByIdQueryHandler.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Actions/Queries/GetUsuarioByIdQueryHandler.php";
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/UseCases/FinishTurno/FinishTurnoUseCase.php";
...
require_once $_SERVER["DOCUMENT_ROOT"] . "/Application/Exceptions/InvalidFinishTurnoException.php";
